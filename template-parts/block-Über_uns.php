 ...
 */
$services = get_field('Über_uns');
if (!empty($services)) : ?>
    <section <?php echo $anchor; ?>class="<?php echo $class_name; ?>">
        <h2 class="is-style-headline"><?php _e('Services','wifi'); ?></h2>
        <div class="columns">
            <?php
            /*
            ...
            foreach ($services as $service) : ?>
                <div class="service column">
                    <figure class="service-icon">
                        <span class="<?php echo $service['icon']; ?>" aria-hidden="false" title="<?php echo $service['title']?>"></span>
                    </figure>
