...
$settings = get_field('posts_settings');
...
if ($news_query->have_posts()): ?>
    <section <?php echo $anchor; ?> class="<?php echo $class_name; ?>">
       <h2 class="is-style-headline"><?php _e('Latest Posts', 'wifi'); ?></h2>
        ...
        */
        if (!empty($settings['link'])): ?>
            <div class="actions">
                <a href="<?php echo $settings['link']; ?>" class="btn"><?php _e('All Posts', 'wifi') ?></a>
            </div>
        <?php endif; ?>
    </section>
<?php
